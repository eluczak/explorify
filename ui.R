...
column(10, offset = 1, class = "main",
        ...
        column(12, class = "",
               fluidRow(
                   column(10, offset = 1, class = "dummy",
                          ...
                          textOutput("num_of_tracks", inline = TRUE),
                          hr(),
    ...
    fluidRow(
        column(12, class = "dashboard_item dummy",
               column(2, offset = 1,
                      br(),br(),
                      p(tags$span(class = "big","3459"),"hours"),
                      p(tags$span(class = "big","789"),"listenings"),
                      p(tags$span(class = "big","17"),"artists"),
                      p(tags$span(class = "big","103"),"tracks"),
                      p("yyyy-mm-dd - yyyy-mm-dd")),
               column(7, offset = 1,
                      br(),br(),
                      p("Mon --------------------------------"),
                      p("Tue ----------------------------------------"),
